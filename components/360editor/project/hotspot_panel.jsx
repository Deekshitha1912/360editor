...
// RIGHT PANEL — arrow palette + logo size control + saved hotspots list
                    ...
                    return (
                        <div key={h.id}
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[10px] text-[#6b6b60]">p:{h.pitch.toFixed(1)} y:{h.yaw.toFixed(1)}</p>
                            </div>
                            <button
                                onClick={() => onDeleteHotspot(h.id)}
                                className="opacity-0 group-hover:opacity-100 w-5 h-5 flex items-center justify-center text-[#6b6b60] hover:text-red-500 transition-all"
                            >
