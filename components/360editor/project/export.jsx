...
function makeHotspotTooltip(div,a){var S=90;div.style.cssText='width:'+S+'px;height:'+S+'px;background:none;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;';var img=document.createElement('img');img.src=a.gif;img.style.cssText='width:'+S+'px;height:'+S+'px;object-fit:contain;filter:drop-shadow(0 3px 12px rgba(0,0,0,.85));pointer-events:none;';div.appendChild(img);var sh='drop-shadow(0 3px 12px rgba(0,0,0,.85))';div.addEventListener('mouseenter',function(){img.style.filter=sh+' brightness(1.2)';});div.addEventListener('mouseleave',function(){img.style.filter=sh;});div.addEventListener('click',function(){if(a.targetSceneId)v.loadScene(a.targetSceneId);});}
